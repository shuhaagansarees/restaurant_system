...
menu_data = {
    ...
    "COLD BEVERAGES": [
        ...
        ("Cold Coffee (Classic)", 69, "Chilled, frothy coffee over ice · S/L", False), # Assuming 69 is the L size or standard, it says 49/69
    ...
    "MOCKTAILS": [
        ...
        ("Blue Lagoon", 109, "Blue curaçao flavour, tangy lemonade", False),
    ...
    "FRIES": [
        ...
        ("Nachos French Fries", 149, "Nacho chips, cheese & jalapeños", False),
        ("Special Loaded Long Fries", 279, "Extra-long fries, cheese, sauces & jalapeños", True)
    ],
    "GARLIC BREAD & TOAST": [
    ...
    "PIZZA": [
        ...
        ("Spicy Tangy Pizza", 169, "Zesty sauces, fiery jalapeños", False),
    ...
    "MAYO PAV": [
        ...
        ("Hot Spicy Pav", 79, "Fiery red chilli spice & jalapeños", False),
    ...
    "MAGGI": [
        ...
        ("Veggie Maggi", 89, "Sautéed garden vegetables", False),
        ("Cheesy Sauce Maggi", 99, "Rich, velvety cheese sauce", False),
        ("Schezwan Cheese Maggi", 109, "Fiery schezwan spice, melted cheese", False),
        ("Vegetable Cheese Maggi", 109, "Sautéed mixed vegetables in creamy cheese sauce", False),
...
with open('menu_data.py', 'w', encoding='utf-8') as f:
    f.write('MENU_DATA = ' + repr(menu_data))
print("Created menu_data.py")
