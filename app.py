...
def auto_migrate():
    with app.app_context():
        ...
        combos_data = [
            ...
            {'name': 'Sandwich Snack Combo', 'desc': 'Veg Cheese Grill + Cold Drink', 'price': 129.0, 'img': '/static/img/combos/sandwich_snack_combo.jpg'},
            {'name': 'Classic Burger Combo', 'desc': 'Standard Veg Burger + Salted Fries + Cold Drink (of your choice)', 'price': 139.0, 'img': '/static/img/combos/classic_burger_combo.jpg'}
        ]
        


        # Hindi translations for all menu items
        translations = {'Hot Beverages / Coffee': 'हॉट बेवरेजेज / कॉफ़ी', 'Black Coffee': 'ब्लैक कॉफ़ी', 'Regular Coffee': 'रेगुलर कॉफ़ी', 'Filter Coffee': 'फ़िल्टर कॉफ़ी', 'Hot Chocolate': 'हॉट चॉकलेट', 'Cold Beverages': 'कोल्ड बेवरेजेज', 'Fresh Lime Soda': 'फ्रेश लाइम सोडा', 'Cold Coffee (Classic)': 'कोल्ड कॉफ़ी (क्लासिक)', 'Cold Coffee (Classic) (S)': 'कोल्ड कॉफ़ी (क्लासिक) (S)', 'Cold Coffee (Classic) (L)': 'कोल्ड कॉफ़ी (क्लासिक) (L)', 'Cold Coffee w/ Ice Cream': 'कोल्ड कॉफ़ी विद आइस क्रीम', 'Lemon Iced Tea': 'लेमन आइस्ड टी', 'Mocktails': 'मॉकटेल', 'Jaljeera Fizz': 'जलजीरा फ़िज़', 'Virgin Mojito': 'वर्जिन मोजिटो', 'Blue Lagoon': 'ब्लू लैगून', 'Watermelon Mint Cooler': 'वाटरमेलन मिंट कूलर', 'Green Apple Fizz': 'ग्रीन एप्पल फ़िज़', 'Strawberry Basil Smash': 'स्ट्रॉबेरी बेसिल स्मैश', 'Blueberry Basil Lemonade': 'ब्लूबेरी बेसिल लेमोनेड', 'Passion Fruit Mojito': 'पैशन फ्रूट मोजिटो', 'Regular Shakes': 'रेगुलर शेक', 'Vanilla Shake': 'वैनिला शेक', 'Strawberry Shake': 'स्ट्रॉबेरी शेक', 'Mango Shake (Seasonal)': 'मैंगो शेक (सीजनल)', 'Butterscotch Shake': 'बटरस्कॉच शेक', 'Kesar Pista Shake': 'केसर पिस्ता शेक', 'Thick / Loaded Shakes': 'थिक / लोडेड शेक', 'Oreo Thick Shake': 'ओरियो थिक शेक', 'KitKat Thick Shake': 'किटकैट थिक शेक', 'Belgian Chocolate Thick Shake': 'बेल्जियन चॉकलेट थिक शेक', 'Ferrero Rocher Thick Shake': 'फेरेरो रोचर थिक शेक', 'Nutella Brownie Thick Shake': 'न्यूटेला ब्राउनी थिक शेक', 'Black Current Thick Shake': 'ब्लैक करंट थिक शेक', 'Lotus Biscoff Thick Shake': 'लोटस बिस्कॉफ थिक शेक', 'Fries': 'फ्राइज़', 'Salted Normal Fries': 'साल्टेड नार्मल फ्राइज़', 'Peri Peri Fries': 'पेरी पेरी फ्राइज़', 'Salted Cheese Fries': 'साल्टेड चीज फ्राइज़', 'Peri Peri Cheese Fries': 'पेरी पेरी चीज फ्राइज़', 'Nachos French Fries': 'नाचोज़ फ्रेंच फ्राइज़', 'Loaded Crispy Long-Stick Fries': 'लोडेड क्रिस्पी लॉन्ग-स्टिक फ्राइज़', 'Garlic Bread & Toast': 'गार्लिक ब्रेड और टोस्ट', 'Salted Masala Toast': 'साल्टेड मसाला टोस्ट', 'Normal Cheese Garlic Bread': 'नार्मल चीज गार्लिक ब्रेड', 'Roasted Onion Pepper Toast': 'रोस्टेड अनियन पेपर टोस्ट', 'Grilled Chilli Toast': 'ग्रिल्ड चिल्ली टोस्ट', 'Cheese Corn Toast': 'चीज कॉर्न टोस्ट', 'Schezwan Toast': 'शेजवान टोस्ट', '5-Flavour Garlic Toast': '५-फ्लेवर गार्लिक टोस्ट', 'Momos': 'मोमोज़', 'Veg Steam Momos': 'वेज स्टीम मोमोज़', 'Fry Veg Momos': 'फ्राई वेज मोमोज़', 'Veg Paneer Steam Momos': 'वेज पनीर स्टीम मोमोज़', 'Cheese Steam Momos': 'चीज स्टीम मोमोज़', 'Fry Paneer / Cheese Momos': 'फ्राई पनीर / चीज मोमोज़', 'Tandoori Peri Peri Momos': 'तंदूरी पेरी पेरी मोमोज़', 'Frankie / Wraps': 'फ्रेंकी / रैप्स', 'Aloo Tikki Frankie': 'आलू टिक्की फ्रेंकी', 'Veg Cheese Frankie': 'वेज चीज फ्रेंकी', 'Tandoori Veg Frankie': 'तंदूरी वेज फ्रेंकी', 'Cheese Corn Frankie': 'चीज कॉर्न फ्रेंकी', 'Paneer Frankie': 'पनीर फ्रेंकी', 'Mexican Veg Frankie': 'मेक्सिकन वेज फ्रेंकी', 'Paneer Tikka Frankie': 'पनीर टिक्का फ्रेंकी', 'Schezwan Paneer Frankie': 'शेजवान पनीर फ्रेंकी', 'Double Cheese Paneer Frankie': 'डबल चीज पनीर फ्रेंकी', 'Sandwich': 'सैंडविच', 'Bread Butter Sandwich': 'ब्रेड बटर सैंडविच', 'Cheese Jam Sandwich': 'चीज जैम सैंडविच', 'Cheese Bread Butter': 'चीज ब्रेड बटर', 'Veg Sandwich': 'वेज सैंडविच', 'Mini Cheese Grill': 'मिनी चीज ग्रिल', 'Veg Cheese Sandwich': 'वेज चीज सैंडविच', 'Cheese Aloo Sandwich': 'चीज आलू सैंडविच', 'Open Cheese Toast': 'ओपन चीज टोस्ट', 'Veg Cheese Grill Sandwich': 'वेज चीज ग्रिल सैंडविच', 'Garlic Cheese Open Toast': 'गार्लिक चीज ओपन टोस्ट', 'Corn Cheese Open Toast': 'कॉर्न चीज ओपन टोस्ट', 'Cheesy Spicy Open Toast': 'चीज़ी स्पाइसी ओपन टोस्ट', 'Bombay Grill Sandwich': 'बॉम्बे ग्रिल सैंडविच', 'Tandoori Paneer Sandwich': 'तंदूरी पनीर सैंडविच', 'Special Protein Sandwich': 'स्पेशल प्रोटीन सैंडविच', 'Matka Sandwich (Veg / Paneer)': 'मटका सैंडविच (वेज / पनीर)', 'Burger': 'बर्गर', 'Standard Veg Burger': 'स्टैण्डर्ड वेज बर्गर', 'Crispy Crunch Burger': 'क्रिस्पी क्रंच बर्गर', 'Red Hot Spicy Burger': 'रेड हॉट स्पाइसी बर्गर', 'Farm House Burger': 'फार्म हाउस बर्गर', 'Tandoori Paneer Burger': 'तंदूरी पनीर बर्गर', 'Original Double Tikki Burger': 'ओरिजिनल डबल टिक्की बर्गर', 'Pizza': 'पिज्जा', 'Margherita Pizza': 'मार्गेरिटा पिज्जा', 'Cheese Corn Pizza': 'चीज कॉर्न पिज्जा', 'Spicy Tangy Pizza': 'स्पाइसी टैंगी पिज्जा', 'Farm House Pizza': 'फार्म हाउस पिज्जा', 'Tandoori Paneer Pizza': 'तंदूरी पनीर पिज्जा', 'Mayo Pav': 'मेयो पाव', 'Solid Masti Pav': 'सॉलिड मस्ती पाव', 'Cream Onion Pav': 'क्रीम अनियन पाव', 'Veggie House Pav': 'वेजी हाउस पाव', 'Hot Spicy Pav': 'हॉट स्पाइसी पाव', 'Tandoori Paneer Pav': 'तंदूरी पनीर पाव', 'Pasta': 'पास्ता', 'Red Sauce Pasta': 'रेड सॉस पास्ता', 'White Sauce Pasta': 'वाइट सॉस पास्ता', 'Pink Sauce Pasta': 'पिंक सॉस पास्ता', 'Maggi': 'मैगी', 'Masala Maggi': 'मसाला मैगी', 'Veggie Maggi': 'वेजी मैगी', 'Cheesy Sauce Maggi': 'चीज़ी सॉस मैगी', 'Schezwan Cheese Maggi': 'शेजवान चीज मैगी', 'Vegetable Cheese Maggi': 'वेजिटेबल चीज मैगी', 'Extra Cheese Maggie': 'एक्स्ट्रा चीज मैगी', 'Desserts': 'डेसर्ट्स', 'Ice Cream (2 Scoops)': 'आइस क्रीम (२ स्कूप्स)', 'Chocolate Lava Cake': 'चॉकलेट लावा केक', 'Brownie (Plain)': 'ब्राउनी (प्लेन)', 'Brownie with Ice Cream': 'ब्राउनी विद आइस क्रीम', 'Belgian Waffle (Choco / Nutella)': 'बेल्जियन वाफल (चोको / न्यूटेला)', 'Waffle with Ice Cream': 'वाफल विद आइस क्रीम', 'Veg Rolls': 'वेज रोल्स', 'Veg Cheese Rolls': 'वेज चीज रोल्स', 'Schezwan Cheese Rolls': 'शेजवान चीज रोल्स', 'Veg Cocktail Rolls': 'वेज कॉकटेल रोल्स', 'Tandoori Veg Wraps': 'तंदूरी वेज रैप्स', 'Veg Cocktail Paneer Wrap': 'वेज कॉकटेल पनीर रैप', 'Veg Paneer Cheese Wrap': 'वेज पनीर चीज रैप', 'Double Cheese Paneer Wrap': 'डबल चीज पनीर रैप', 'Margherita Pizza Combo': 'मार्गेरिटा पिज्जा कॉम्बो', 'Sandwich Snack Combo': 'सैंडविच स्नैक कॉम्बो', 'Classic Burger Combo': 'क्लासिक बर्गर कॉम्बो', 'ROLLS/WRAPS': 'रोल्स/रैप्स'}
        ...
        # Gujarati translations (safely applied only if empty)
        gu_translations = {'Hot Beverages / Coffee': 'હોટ બેવરેજીસ / કૉફી', 'Black Coffee': 'બ્લેક કૉફી', 'Regular Coffee': 'રેગ્યુલર કૉફી', 'Filter Coffee': 'ફિલ્ટર કૉફી', 'Hot Chocolate': 'હોટ ચોકલેટ', 'Cold Beverages': 'કોલ્ડ બેવરેજીસ', 'Fresh Lime Soda': 'ફ્રેશ લાઈમ સોડા', 'Cold Coffee (Classic)': 'કોલ્ડ કૉફી (ક્લાસિક)', 'Cold Coffee (Classic) (S)': 'કોલ્ડ કૉફી (ક્લાસિક) (S)', 'Cold Coffee (Classic) (L)': 'કોલ્ડ કૉફી (ક્લાસિક) (L)', 'Cold Coffee w/ Ice Cream': 'કોલ્ડ કૉફી વિથ આઈસ ક્રીમ', 'Lemon Iced Tea': 'લેમન આઈસ્ડ ટી', 'Mocktails': 'મોકટેલ', 'Jaljeera Fizz': 'જલજીરા ફિઝ', 'Virgin Mojito': 'વર્જિન મોજિટો', 'Blue Lagoon': 'બ્લુ લગૂન', 'Watermelon Mint Cooler': 'વોટરમેલન મિન્ટ કુલર', 'Green Apple Fizz': 'ગ્રીન એપલ ફિઝ', 'Strawberry Basil Smash': 'સ્ટ્રોબેરી બેઝિલ સ્મેશ', 'Blueberry Basil Lemonade': 'બ્લુબેરી બેઝિલ લેમોનેડ', 'Passion Fruit Mojito': 'પેશન ફ્રૂટ મોજિટો', 'Regular Shakes': 'રેગ્યુલર શેક', 'Vanilla Shake': 'વેનિલા શેક', 'Strawberry Shake': 'સ્ટ્રોબેરી શેક', 'Mango Shake (Seasonal)': 'મેંગો શેક (સીઝનલ)', 'Butterscotch Shake': 'બટરસ્કોચ શેક', 'Kesar Pista Shake': 'કેસર પિસ્તા શેક', 'Thick / Loaded Shakes': 'થિક / લોડેડ શેક', 'Oreo Thick Shake': 'ઓરિયો થિક શેક', 'KitKat Thick Shake': 'કિટકેટ થિક શેક', 'Belgian Chocolate Thick Shake': 'બેલ્જિયન ચોકલેટ થિક શેક', 'Ferrero Rocher Thick Shake': 'ફેરેરો રોચર થિક શેક', 'Nutella Brownie Thick Shake': 'ન્યુટેલા બ્રાઉની થિક શેક', 'Black Current Thick Shake': 'બ્લેક કરંટ થિક શેક', 'Lotus Biscoff Thick Shake': 'લોટસ બિસ્કોફ થિક શેક', 'Fries': 'ફ્રાઈસ', 'Salted Normal Fries': 'સોલ્ટેડ નોર્મલ ફ્રાઈસ', 'Peri Peri Fries': 'પેરી પેરી ફ્રાઈસ', 'Salted Cheese Fries': 'સોલ્ટેડ ચીઝ ફ્રાઈસ', 'Peri Peri Cheese Fries': 'પેરી પેરી ચીઝ ફ્રાઈસ', 'Nachos French Fries': 'નાચોસ ફ્રેન્ચ ફ્રાઈસ', 'Loaded Crispy Long-Stick Fries': 'લોડેડ ક્રિસ્પી લોન્ગ-સ્ટિક ફ્રાઈસ', 'Garlic Bread & Toast': 'ગાર્લિક બ્રેડ એન્ડ ટોસ્ટ', 'Salted Masala Toast': 'સોલ્ટેડ મસાલા ટોસ્ટ', 'Normal Cheese Garlic Bread': 'નોર્મલ ચીઝ ગાર્લિક બ્રેડ', 'Roasted Onion Pepper Toast': 'રોસ્ટેડ અનિયન પેપર ટોસ્ટ', 'Grilled Chilli Toast': 'ગ્રીલ્ડ ચિલી ટોસ્ટ', 'Cheese Corn Toast': 'ચીઝ કોર્ન ટોસ્ટ', 'Schezwan Toast': 'શેઝવાન ટોસ્ટ', '5-Flavour Garlic Toast': '૫-ફ્લેવર ગાર્લિક ટોસ્ટ', 'Momos': 'મોમોઝ', 'Veg Steam Momos': 'વેજ સ્ટીમ મોમોઝ', 'Fry Veg Momos': 'ફ્રાય વેજ મોમોઝ', 'Veg Paneer Steam Momos': 'વેજ પનીર સ્ટીમ મોમોઝ', 'Cheese Steam Momos': 'ચીઝ સ્ટીમ મોમોઝ', 'Fry Paneer / Cheese Momos': 'ફ્રાય પનીર / ચીઝ મોમોઝ', 'Tandoori Peri Peri Momos': 'તંદૂરી પેરી પેરી મોમોઝ', 'Frankie / Wraps': 'ફ્રેન્કી / રેપ્સ', 'Aloo Tikki Frankie': 'આલૂ ટિક્કી ફ્રેન્કી', 'Veg Cheese Frankie': 'વેજ ચીઝ ફ્રેન્કી', 'Tandoori Veg Frankie': 'તંદૂરી વેજ ફ્રેન્કી', 'Cheese Corn Frankie': 'ચીઝ કોર્ન ફ્રેન્કી', 'Paneer Frankie': 'પનીર ફ્રેન્કી', 'Mexican Veg Frankie': 'મેક્સિકન વેજ ફ્રેન્કી', 'Paneer Tikka Frankie': 'પનીર ટિક્કા ફ્રેન્કી', 'Schezwan Paneer Frankie': 'શેઝવાન પનીર ફ્રેન્કી', 'Double Cheese Paneer Frankie': 'ડબલ ચીઝ પનીર ફ્રેન્કી', 'Sandwich': 'સેન્ડવીચ', 'Bread Butter Sandwich': 'બ્રેડ બટર સેન્ડવીચ', 'Cheese Jam Sandwich': 'ચીઝ જામ સેન્ડવીચ', 'Cheese Bread Butter': 'ચીઝ બ્રેડ બટર', 'Veg Sandwich': 'વેજ સેન્ડવીચ', 'Mini Cheese Grill': 'મિની ચીઝ ગ્રીલ', 'Veg Cheese Sandwich': 'વેજ ચીઝ સેન્ડવીચ', 'Cheese Aloo Sandwich': 'ચીઝ આલૂ સેન્ડવીચ', 'Open Cheese Toast': 'ઓપન ચીઝ ટોસ્ટ', 'Veg Cheese Grill Sandwich': 'વેજ ચીઝ ગ્રીલ સેન્ડવીચ', 'Garlic Cheese Open Toast': 'ગાર્લિક ચીઝ ઓપન ટોસ્ટ', 'Corn Cheese Open Toast': 'કોર્ન ચીઝ ઓપન ટોસ્ટ', 'Cheesy Spicy Open Toast': 'ચીઝી સ્પાઈસી ઓપન ટોસ્ટ', 'Bombay Grill Sandwich': 'બોમ્બે ગ્રીલ સેન્ડવીચ', 'Tandoori Paneer Sandwich': 'તંદૂરી પનીર સેન્ડવીચ', 'Special Protein Sandwich': 'સ્પેશિયલ પ્રોટીન સેન્ડવીચ', 'Matka Sandwich (Veg / Paneer)': 'મટકા સેન્ડવીચ (વેજ / પનીર)', 'Burger': 'બર્ગર', 'Standard Veg Burger': 'સ્ટાન્ડર્ડ વેજ બર્ગર', 'Crispy Crunch Burger': 'ક્રિસ્પી ક્રંચ બર્ગર', 'Red Hot Spicy Burger': 'રેડ હોટ સ્પાઈસી બર્ગર', 'Farm House Burger': 'ફાર્મ હાઉસ બર્ગર', 'Tandoori Paneer Burger': 'તંદૂરી પનીર બર્ગર', 'Original Double Tikki Burger': 'ઓરિજિનલ ડબલ ટિક્કી બર્ગર', 'Pizza': 'પિઝા', 'Margherita Pizza': 'માર્ગેરિટા પિઝા', 'Cheese Corn Pizza': 'ચીઝ કોર્ન પિઝા', 'Spicy Tangy Pizza': 'સ્પાઈસી ટેન્ગી પિઝા', 'Farm House Pizza': 'ફાર્મ હાઉસ પિઝા', 'Tandoori Paneer Pizza': 'તંદૂરી પનીર પિઝા', 'Mayo Pav': 'મેયો પાવ', 'Solid Masti Pav': 'સોલિડ મસ્તી પાવ', 'Cream Onion Pav': 'ક્રીમ અનિયન પાવ', 'Veggie House Pav': 'વેજી હાઉસ પાવ', 'Hot Spicy Pav': 'હોટ સ્પાઈસી પાવ', 'Tandoori Paneer Pav': 'તંદૂરી પનીર પાવ', 'Pasta': 'પાસ્તા', 'Red Sauce Pasta': 'રેડ સોસ પાસ્તા', 'White Sauce Pasta': 'વ્હાઇટ સોસ પાસ્તા', 'Pink Sauce Pasta': 'પિંક સોસ પાસ્તા', 'Maggi': 'મેગી', 'Masala Maggi': 'મસાલા મેગી', 'Veggie Maggi': 'વેજી મેગી', 'Cheesy Sauce Maggi': 'ચીઝી સોસ મેગી', 'Schezwan Cheese Maggi': 'શેઝવાન ચીઝ મેગી', 'Vegetable Cheese Maggi': 'વેજીટેબલ ચીઝ મેગી', 'Extra Cheese Maggie': 'એક્સ્ટ્રા ચીઝ મેગી', 'Desserts': 'ડેઝર્ટ્સ', 'Ice Cream (2 Scoops)': 'આઇસ ક્રીમ (૨ સ્કૂપ્સ)', 'Chocolate Lava Cake': 'ચોકલેટ લાવા કેક', 'Brownie (Plain)': 'બ્રાઉની (પ્લેન)', 'Brownie with Ice Cream': 'બ્રાઉની વિથ આઇસ ક્રીમ', 'Belgian Waffle (Choco / Nutella)': 'બેલ્જિયન વાફલ (ચોકો / ન્યુટેલા)', 'Waffle with Ice Cream': 'વાફલ વિથ આઇસ ક્રીમ', 'Veg Rolls': 'વેજ રોલ્સ', 'Veg Cheese Rolls': 'વેજ ચીઝ રોલ્સ', 'Schezwan Cheese Rolls': 'શેઝવાન ચીઝ રોલ્સ', 'Veg Cocktail Rolls': 'વેજ કોકટેલ રોલ્સ', 'Tandoori Veg Wraps': 'તંદૂરી વેજ રેપ્સ', 'Veg Cocktail Paneer Wrap': 'વેજ કોકટેલ પનીર રેપ', 'Veg Paneer Cheese Wrap': 'વેજ પનીર ચીઝ રેપ', 'Double Cheese Paneer Wrap': 'ડબલ ચીઝ પનીર રેપ', 'Margherita Pizza Combo': 'માર્ગેરિટા પિઝા કોમ્બો', 'Sandwich Snack Combo': 'સેન્ડવીચ સ્નેક કોમ્બો', 'Classic Burger Combo': 'ક્લાસિક બર્ગર કોમ્બો', 'ROLLS/WRAPS': 'રોલ્સ/રેપ્સ'}
        
        cats = Category.query.all()
        for c in cats:
            if c.name in gu_translations and not c.name_gu:
                c.name_gu = gu_translations[c.name]
                
        items = MenuItem.query.all()
        for i in items:
            if i.name in gu_translations and not i.name_gu:
                i.name_gu = gu_translations[i.name]
                
        db.session.commit()

        # Clean up old combos
        valid_combos = ['Margherita Pizza Combo', 'Sandwich Snack Combo', 'Classic Burger Combo']
        old_combos = MenuItem.query.filter(MenuItem.is_combo == True).all()
        for c in old_combos:
            if c.name not in valid_combos:
                db.session.delete(c)
        db.session.commit()
        ...
        # --- NEW PRICES UPDATE SEP 22 ---
        price_updates = {
            'Cheese Aloo Sandwich': 75.0,
            'Veg Cheese Sandwich': 89.0,
            'Mini Cheese Grill': 99.0,
            'Veg Cheese Grill Sandwich': 149.0,
            'Matka Sandwich (Veg / Paneer)': 169.0,
            'Tandoori Paneer Sandwich': 199.0,
            'White Sauce Pasta': 149.0,
            'Lotus Biscoff Thick Shake': 189.0,
            'Extra Cheese Maggie': 119.0,
        ...
        if shake_cat:
            bc_shake = MenuItem.query.filter_by(name='Black Current Thick Shake').first()
            if not bc_shake:
                mi = MenuItem(name='Black Current Thick Shake', price=179.0, description='Rich black current flavour, thick & creamy', category_id=shake_cat.id, food_type='veg')
                db.session.add(mi)
...
def magic_add_menu():
    try:
        ...
        menu_dict = {'Hot Beverages / Coffee': [('Black Coffee', 39, 'Bold espresso, pure & unsweetened', False),
 ...
 'Cold Beverages': [('Fresh Lime Soda', 49, 'Sweet, salted or mixed - your choice', False),
 ...
 'Mocktails': [('Jaljeera Fizz', 89, 'Spiced jaljeera, soda & crunchy boondi', False),
 ...
 'Regular Shakes': [('Vanilla Shake', 89, 'Classic vanilla bean & chilled milk', False),
 ...
 'Thick / Loaded Shakes': [('Oreo Thick Shake', 139, 'Crushed Oreo & creamy ice cream', False),
                           ...
                           ('Black Current Thick Shake', 179, 'Rich black current flavour, thick & creamy', False),
                           ('Lotus Biscoff Thick Shake', 189, 'Crushed Biscoff & spiced cookie butter', True)],
 'Fries': [('Salted Normal Fries', 79, 'Golden fries, classic sea salt', False),
           ...
           ('Loaded Crispy Long-Stick Fries', 279, 'Extra-long fries, cheese, sauces & jalapenos', True)],
 'Garlic Bread & Toast': [('Salted Masala Toast', 99, 'Garlic butter & Indian spice blend', False),
 ...
 'Momos': [('Veg Steam Momos', 99, 'Steamed, stuffed with fresh vegetables', False),
 ...
 'Frankie / Wraps': [('Aloo Tikki Frankie', 59, 'Spiced potato patty, tangy chutneys', False),
 ...
 'Sandwich': [('Bread Butter Sandwich', 49, 'Soft bread, creamy butter', False),
              ...
              ('Mini Cheese Grill', 99, 'Toasted pockets, melted cheese & herbs', False),
              ('Veg Cheese Sandwich', 89, 'Sliced vegetables, smooth melted cheese', False),
              ('Cheese Aloo Sandwich', 75, 'Spiced potato filling & melted cheese', False),
              ('Open Cheese Toast', 99, 'Golden toast loaded with gooey cheese', False),
              ('Veg Cheese Grill Sandwich', 149, 'Grilled, crunchy veg & melted cheese', False),
              ...
              ('Tandoori Paneer Sandwich', 199, 'Smoky tandoori paneer, grilled', False),
              ('Special Protein Sandwich', 149, 'Protein-rich grilled filling, fitness-focused & fresh', False),
              ('Matka Sandwich (Veg / Paneer)', 169, 'Chefs special served in an earthen pot', True)],
 'Burger': [('Standard Veg Burger', 79, 'Potato-veggie patty, lettuce & mayo', False),
 ...
 'Mayo Pav': [('Solid Masti Pav', 59, 'Buttery pav, seasoned veggie patty', False),
 ...
 'Pasta': [('Red Sauce Pasta', 139, 'Tangy tomato-basil, garlic & herbs', False),
           ('White Sauce Pasta', 149, 'Silky garlic-cream sauce, melted cheese', False),
           ('Pink Sauce Pasta', 169, 'Tomato marinara meets creamy white sauce', False)],
 'Maggi': [('Masala Maggi', 69, 'Classic noodles, savoury Indian spice', False),
           ...
           ('Vegetable Cheese Maggi', 129, 'Sauteed mixed vegetables in creamy cheese sauce', False),
           ('Extra Cheese Maggie', 119, 'Extra velvety cheese sauce, ultra creamy', False)],
 'Desserts': [('Ice Cream (2 Scoops)', 79, 'Classic flavour, cold & creamy', False),
